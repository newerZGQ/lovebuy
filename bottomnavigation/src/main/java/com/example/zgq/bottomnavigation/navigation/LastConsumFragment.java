...
import com.example.zgq.lovebuy.ui.activity.AddConsumActivity;
import com.example.zgq.lovebuy.ui.activity.ConsumActivity;
...
public class LastConsumFragment extends Fragment {
    ...
    public TextView myLastConsum;
    public TextView otherConsum;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_last_consum, container, false);
        Button addConsum = (Button) view.findViewById(R.id.add_consum_bitton);
        addConsum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), AddConsumActivity.class));
            }
        });
        myLaCoLay = (LinearLayout) view.findViewById(R.id.my_laCo_lay);
        myLaCoLay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.putExtra("myORother", "ohter");
                startActivity(new Intent(getActivity(), ConsumActivity.class));
            }
        });
        ...
        otherLaCoLay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.putExtra("myORother", "my");
                startActivity(new Intent(getActivity(), ConsumActivity.class));
            }
        });
        myLastConsum = (TextView) view.findViewById(R.id.my_lastConsum);
        otherConsum = (TextView) view.findViewById(R.id.other_lastConsum);
        uri = Uri.parse(ConsumContentProvider.URI + "/consum");
        getActivity().getContentResolver().registerContentObserver(uri, true, new ConsumObserver(new Handler()));
        myLast = DBOperateTools.getLastConsum(context, uri);
        Log.d("--->>",myLast.getDate());
        myLastConsum.setText("" + myLast.getNumber() + myLast.getLable() +myLast.getDate() + myLast.getHappiness() + myLast.getDetail() + myLast.getProperty());
        return view;
    }
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onLastConsumFragmentInteraction(uri);
        }
    }
