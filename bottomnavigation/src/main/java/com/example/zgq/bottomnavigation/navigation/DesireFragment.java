...
public class DesireFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_desire, container, false);
        TextView textView = (TextView) view.findViewById(R.id.desire_frag_text);
        return view;
    }
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onDeaireFragmentInteraction(uri);
        }
    }
